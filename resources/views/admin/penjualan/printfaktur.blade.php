...
<head>
  ...
  <title>Print Faktur Penjualan | Dragon KOi</title>
...
<body onload="window.print();">
  ...
  <div class="row">
    <div class="col-xs-12 table-responsive">
      <table class="table mytable">
        <thead>
          <tr>
            <td colspan="6"><div class="header-page-space">&nbsp;</div></td>
          </tr>
          <tr>
        ...
        @endforeach
          <tr>
            ...
            <td><b>Rp {{ number_format($data->hrg_total) }}</b></td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
  ...
  <!-- /.row -->
  <div class="header-page">I'M THE HEADER NOW/div>
