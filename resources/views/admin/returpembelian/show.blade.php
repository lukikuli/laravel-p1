            ...
            <section class="invoice">
              ...
              <div class="row invoice-info">
                ...
                @if(!is_null($data->pembelian->supplier))
                  Dari
                  <address>
                    <strong>{{ $data->pembelian->supplier->nama }}<br>
                    {{ $data->pembelian->supplier->alamat }}<br>
                    {{ $data->pembelian->supplier->kota }}<br>
                    Telp : {{ $data->pembelian->supplier->telp_1 }} <br> {{ $data->pembelian->supplier->telp_2 }}<br>
                    </strong>
                  </address>
                @endif
                </div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-2">Faktur</div><div class="col-sm-10">: {{ $data->pembelian->no_faktur }}</div>
              ...
              <div class="row no-print">
                <div class="col-xs-12">
                    <a href="{{ route('returpembelian.printfaktur', ['id' => encrypt($data->no_retur)]) }}" class=" btn btn-md btn-primary" target="_blank">Print</a>
                  <a href="{{ route('returpembelian.index') }}" class="btn btn-md btn-danger">Back</a>
                </div>
              </div>
            </section>
        </div>
