...
<head>
  ...
  <title>Print Retur Pembelian | Dragon KOi</title>
  ...
  <div class="row">
    ...
    <div class="col-xs-4 pull-right">
      <p style="margin:0px; line-height:20px; margin-left: 50px;">
        <strong>RETUR PEMBELIAN</strong><br>
        Tanggal: {{ date('d-M-Y') }}<br>
        @if(!is_null($data->pembelian->supplier))
          Kepada Yth.<br>
            {{ $data->pembelian->supplier->nama }}<br>
            {{ $data->pembelian->supplier->alamat .", ". $data->pembelian->supplier->kota }}<br>
            Telp : {{ $data->pembelian->supplier->telp_1 }} {{ $data->pembelian->supplier->telp_2 != null ? ", ". $data->pembelian->supplier->telp_2 : ""}}<br>
        @endif
      </p>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6 pull-left">
        <div class="col-xs-5">No. Faktur</div><div class="col-xs-7">: {{ $data->pembelian->no_faktur }}</div>
        <div class="col-xs-5">Tanggal Faktur</div><div class="col-xs-7">: {{ date('d-M-Y', strtotime($data->pembelian->tgl_beli)) }}</div>
