...
@section('content')
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <hr>
            <form autocomplete="off" action="{{ route('pelanggan.store') }}" method="post">
                @csrf
                <div class="form-group">
                    ...
                    @endif
                    <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama') }}" autofocus maxlength="191">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    @endif
                    <textarea class="form-control" id="alamat" name="alamat" maxlength="191">{{old('alamat')}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    @endif
                    <textarea class="form-control" id="keterangan" name="keterangan" maxlength="700" rows="15">{{old('keterangan')}}</textarea>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-md btn-primary">Submit</button>
                    <a href="{{ route('pelanggan.index') }}" class="btn btn-md btn-danger">Back</a>
                </div>
            </form>
        </div>
        <!-- /.content -->
