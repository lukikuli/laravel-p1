...
@section('content')
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <h1>Edit Customer</h1>
            <hr>
            <form autocomplete="off" action="{{ route('pelanggan.update', $data->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="form-group">
                    ...
                    @endif
                    <input type="text" class="form-control" id="nama" name="nama" value="{{ $data->nama }}" autofocus maxlength="191">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    @endif
                    <textarea class="form-control" id="keterangan" name="keterangan" maxlength="700" rows="15">{{$data->keterangan}}</textarea>
                </div>
                <div class="form-group">
